export class MessageContstants {
    ...
    public static LOGIN_OK_MSG = "Đăng nhập hệ thống thành công.";
    public static LOGIN_FAILED_MSG = "Đăng nhập hệ thống thất bại.";
    public static LOGOUT_OK_MSG = "Đăng xuất hệ thống thành công.";
